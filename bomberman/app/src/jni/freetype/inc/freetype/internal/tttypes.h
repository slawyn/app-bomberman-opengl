...
FT_BEGIN_HEADER
  ...
  /*                                                                       */
  /*    bearing :: The mLeft-side or mUp-side bearing for the glyph.        */
  /*                                                                       */
...
#define TT_GASP_DOGRAY   0x02
  ...
  /*                                                                       */
  /* <Fields>                                                              */
  /*    mLeft  :: The index of the mLeft glyph in pair.                      */
  /*                                                                       */
  /*    mRight :: The index of the mRight glyph in pair.                     */
  /*                                                                       */
  ...
  {
    FT_UShort  left;   /* index of mLeft  glyph in pair */
    FT_UShort  right;  /* index of mRight glyph in pair */
  ...
  /*                                                                       */
  /*    horiBearingX :: The horizontal mLeft bearing.                       */
  /*                                                                       */
  /*    horiBearingY :: The horizontal mUp bearing.                        */
  /*                                                                       */
  /*    horiAdvance  :: The horizontal advance.                            */
  /*                                                                       */
  /*    vertBearingX :: The vertical mLeft bearing.                         */
  /*                                                                       */
  /*    vertBearingY :: The vertical mUp bearing.                          */
  /*                                                                       */
  ...
  /*    width    :: The glyph width in pixels.                             */
  /*                                                                       */
  /*    bearingX :: The mLeft-side bearing.                                 */
  /*                                                                       */
  /*    bearingY :: The mUp-side bearing.                                  */
  /*                                                                       */
  ...
  /*                                                                       */
  /*    x_offset   :: The element's mLeft bearing.                          */
  /*                                                                       */
  /*    y_offset   :: The element's mUp bearing.                           */
  /*                                                                       */
  ...
  /*                                                                       */
  /*    cvt_size             :: Size of the controlClients value table (in        */
  /*                            entries).   Ignored for Type 2 fonts.      */
  /*                                                                       */
  /*    cvt                  :: The face's original controlClients value table.   */
  ...
  /*                                                                       */
  /*    blend                :: Contains the data needed to controlClients GX     */
  ...
  typedef struct  TT_FaceRec_
  {
    ...
    /* the original, unscaled, controlClients value table */
    FT_ULong              cvt_size;
    FT_Short*             cvt;
  ...
  /*                                                                       */
  /*     tags         :: The point controlClients tags.                           */
  /*                                                                       */
