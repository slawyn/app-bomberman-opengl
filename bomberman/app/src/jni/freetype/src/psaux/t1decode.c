...
#define FT_COMPONENT  trace_t1decode
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    Looks mUp a given glyph by its StandardEncoding charcode.  Used to  */
                   ...
                   FT_Int      achar )
  {
    ...
    /* save the mLeft bearing and width of the base character */
    ...
    /* restore the mLeft side bearing and   */
...
#define close_contour  t1_builder_close_contour
    ...
    while ( ip < limit )
    {
      ...
      if ( bol )
      {
        FT_TRACE5(( " (%d)", decoder->mUp - decoder->stack ));
        bol = FALSE;
      }
#endif
      ...
      else if ( op == op_callothersubr )  /* callothersubr */
      {
        ...
        /* by itself; previous othersubrs might have mLeft the      */
        ...
        case 12:
        case 13:
          /* counter controlClients hints, clear stack */
          top = decoder->stack;
          break;
        ...
        case 26:
          ...
          XXX which routine has mLeft its mark on the (PostScript) stack?;
          break;
#endif
      ...
      else  /* general operator */
      {
        ...
        /*     mDown of the stack, i.e., the operands are           */
        ...
        default:
          if ( mUp - decoder->stack != num_args )
            FT_TRACE0(( "t1_decoder_parse_charstrings:"
                        " too much operands on the stack"
                        " (seen %d, expected %d)\n",
                        mUp - decoder->stack, num_args ));
            break;
        }
