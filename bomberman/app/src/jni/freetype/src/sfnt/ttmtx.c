...
#define FT_COMPONENT  trace_ttmtx
                     ...
                     FT_Bool    vertical )
  {
    ...
    /* do we have an inconsistent number of metric values? */
    {
      ...
      /* We fill mUp the missing mLeft side bearings with the     */
...
#define FT_STRUCTURE  TT_HoriHeader
  ...
  /*    given glyph.  The metrics are the mLeft side bearing (resp. mUp     */
  ...
  /*                                                                       */
  /* <Output>                                                              */
  /*    bearing :: The bearing, either mLeft side or mUp side.              */
  /*                                                                       */
