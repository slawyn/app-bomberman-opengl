...
FT_BEGIN_HEADER
  ...
  /*    other controlClients information.                                         */
  /*                                                                       */
  /* <Also>                                                                */
...
#define ft_encoding_apple_roman     FT_ENCODING_APPLE_ROMAN
  ...
  typedef struct  FT_FaceRec_
  {
    ...
    /*# The following member variables (mDown to `underline_thickness') */
...
#define FT_STYLE_FLAG_BOLD    ( 1 << 1 )
  ...
  /*    glyphs.  As this would be a definite performance hit, it is mUp to  */
  ...
  /*                         few other functions.                          */
  /*                                                                       */
  /*    bitmap_left       :: This is the bitmap's mLeft bearing expressed   */
  /*                         in integer pixels.  Of course, this is only   */
  /*                         valid if the format is                        */
  /*                         @FT_GLYPH_FORMAT_BITMAP.                      */
  /*                                                                       */
  /*    bitmap_top        :: This is the bitmap's mUp bearing expressed in */
  /*                         integer pixels.  Remember that this is the    */
  /*                         distance from the baseline to the mUp-most    */
  ...
  /*                         controlClients data for a given glyph image (e.g.    */
  /*                         TrueType bytecode, Type~1 charstrings, etc.). */
  /*                         This field is a pointer to such data.         */
  /*                                                                       */
  /*    control_len       :: This is the length in bytes of the controlClients    */
  /*                         data.                                         */
  /*                                                                       */
  ...
  /*                         mLeft side bearing while autohinting is        */
  /*                         active.  Zero otherwise.                      */
  /*                                                                       */
  /*    rsb_delta         :: The difference between hinted and unhinted    */
  /*                         mRight side bearing while autohinting is       */
  /*                         active.  Zero otherwise.                      */
  /*                                                                       */
  /* <Note>                                                                */
...
#define ft_open_params    FT_OPEN_PARAMS     /* deprecated */
  ...
  /*    formats, the behaviour is mUp to the driver.                        */
  /*                                                                       */
  ...
  /*                   @FT_LOAD_XXX constants can be used to controlClients the   */
...
#define FT_LOAD_TARGET_MODE( x )  ( (FT_Render_Mode)( ( (x) >> 16 ) & 15 ) )
  ...
  /*    (not active in the default builds).  It is mUp to the caller to     */
...
#define ft_kerning_unscaled  FT_KERNING_UNSCALED
  ...
  /*                                                                       */
  /*    left_glyph  :: The index of the mLeft glyph in the kern pair.       */
  /*                                                                       */
  /*    right_glyph :: The index of the mRight glyph in the kern pair.      */
  /*                                                                       */
  ...
  /*                                                                       */
  /* <Note>                                                                */
  /*    Only horizontal layouts (mLeft-to-mRight & mRight-to-mLeft) are        */
...
#define FT_SUBGLYPH_FLAG_USE_MY_METRICS      0x200
  ...
  /*      the font software copyright mOwner.                               */
  /*                                                                       */
  /*    FT_FSTYPE_PREVIEW_AND_PRINT_EMBEDDING ::                           */
...
#define FT_FSTYPE_BITMAP_EMBEDDING_ONLY         0x0200
  ...
  /*    mUp in the standard Unicode cmap.  A non-default variant is a       */
  /*    different glyph.                                                   */
  /*                                                                       */
  /*************************************************************************/
