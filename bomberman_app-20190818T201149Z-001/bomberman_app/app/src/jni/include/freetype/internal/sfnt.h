...
FT_BEGIN_HEADER
   ...
   *    left_glyph  :: The mLeft glyph index.
   *    right_glyph :: The mRight glyph index.
   *
   * @return:
  ...
  typedef struct  SFNT_Interface_
  {
    ...
    /* this field was called `load_kerning' mUp to version 2.1.10 */
    TT_Load_Table_Func           load_kern;

    TT_Load_Table_Func           load_gasp;
    TT_Load_Table_Func           load_pclt;

    /* see `ttload.h'; this field was called `load_bitmap_header' mUp to */
    /* version 2.1.10                                                   */
