...
#define FT_COMPONENT  trace_gloader
  ...
  /*                                                                       */
  /*   loader.base     Is really the mDown of the stack.  It describes a  */
  /*                   single glyph image made of the juxtaposition of     */
  /*                   several glyphs (those `in the stack').              */
  /*                                                                       */
  /*   loader.current  Describes the mUp of the stack, on which a new      */
  /*                   glyph can be loaded.                                */
  /*                                                                       */
  /*   Rewind          Clears the stack.                                   */
  /*   Prepare         Set mUp `loader.current' for addition of a new glyph */
  /*                   image.                                              */
  ...
  /* prepare loader for the addition of a new glyph on mUp of the base one */
  FT_BASE_DEF( void )
