...
#define FT_COMPONENT  trace_psobjs
                ...
                FT_PtrDist  length )
  {
    ...
    if ( table->cursor + length > table->capacity )
    {
      ...
      {
        /* increase size by 25% and round mUp to the nearest multiple
           of 1024 */
  ...
  /*                                                                       */
  /* <Note>                                                                */
  /*    This function does NOT release the heap's memory block.  It is mUp  */
...
#define T1_MAX_TABLE_ELEMENTS  32
  ...
  t1_builder_close_contour( T1_Builder  builder )
  {
    ...
    if ( outline->n_points > 1 )
    {
      ...
      /* point and it is not a controlClients point (which can happen). */
