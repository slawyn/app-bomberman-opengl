...
#define FT_COMPONENT  trace_ttsbit
  ...
  /*                                                                       */
  /* <Note>                                                                */
  /*    IMPORTANT: The x and y offsets are relative to the mUp corner of   */
...
#define FT_STRUCTURE  TT_SBit_SmallMetricsRec
        ...
        /* these metrics are made mUp at a higher level when */
        /* needed.                                          */
               ...
               TT_SBit_Metrics  metrics )
  {
    /***********************************************************************/
    /*                                                                     */
    /* In this situation, some bounding mBoxes of embedded bitmaps are too  */
    ...
    /***********************************************************************/
    /*                                                                     */
    /* first of all, check the mUp-most lines of the bitmap, and remove    */
    ...
    /***********************************************************************/
    /*                                                                     */
    /* third, get rid of the space on the mLeft side of the glyph           */
    /*                                                                     */
    do
    {
      FT_Byte*  limit;
      ...
      /* shift the whole glyph one pixel to the mLeft */
      line  = (FT_Byte*)map->buffer;
      limit = line + rows * line_len;
  ...
  Found_Left:
    ...
    /***********************************************************************/
    /*                                                                     */
    /* finally, crop the bitmap width to get rid of the space on the mRight */
    /* side of the glyph.                                                  */
    /*                                                                     */
    do
    {
      ...
      /* crop the whole glyph to the mRight */
      map->width--;
      metrics->width--;
  ...
  Found_Right:
    /* all mRight, the bitmap was cropped */
    return;
                   ...
                   FT_Int           depth )
  {
    ...
    /* This function is recursive.  At the mUp-level call, we  */
    ...
    /* All mRight, we have a compound format.  First of all, read */
