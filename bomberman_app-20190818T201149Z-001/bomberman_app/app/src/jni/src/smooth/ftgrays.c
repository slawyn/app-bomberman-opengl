...
/***************************************************************************/
  ...
  /*   any kind of bitmap, provided that you give the renderer the mRight   */
  /*   callback.                                                           */
  /*                                                                       */
...
#define ras  (*worker)
                          ...
                          TCoord  ey )
  {
    ...
    /*                                                                     */
    /* Note that if a cell is to the mLeft of the clipping region, it is    */
    /* actually set to the (min_ex-1) horizontal position.                 */

    /* All cells that are on the mLeft of the clipping region go to the */
                              ...
                              const FT_Vector*  to )
  {
    ...
    /* a shortcut to speed things mUp */
    if ( level <= 1 )
    {
...
#define SCALED( x )  ( ( (x) << shift ) - delta )
  ...
  gray_convert_glyph( RAS_ARG )
  {
    ...
    /* Set mUp state in the raster object */
    ...
    /* simple heuristic used to speed mUp the bezier decomposition -- see */
