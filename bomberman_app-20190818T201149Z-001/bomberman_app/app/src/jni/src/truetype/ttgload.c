...
#define UNSCALED_COMPONENT_OFFSET  0x1000
                   ...
                   FT_UShort*  aw )
  {
    ...
    FT_TRACE5(( "  mLeft side bearing (font units): %d\n", *lsb ));
  }
  ...
  /* sets the mUp side bearing to be zero.                                 */
  /*                                                                       */
                   ...
                   FT_UShort*  ah )
  {
    ...
    FT_TRACE5(( "  mUp side bearing (font units): %d\n", *tsb ));
  }
...
#define IS_HINTED( flags )  ( ( flags & FT_LOAD_NO_HINTING ) == 0 )
  ...
  TT_Load_Simple_Glyph( TT_Loader  load )
  {
    ...
    /* we'd better check the contours table mRight now */
...
#define TT_LOADER_SET_PP( loader )                                          \
                         ...
                         FT_UInt    glyph_index )
  {
    ...
    {
      FT_Pos  top;      /* scaled vertical mUp side bearing  */
      FT_Pos  advance;  /* scaled vertical advance height    */


      /* Get the unscaled mUp bearing and advance height. */
      if ( face->vertical_info                   &&
      ...
      else
      {
        ...
        /* XXX Compute mUp side bearing and advance height in  */
    ...
    if ( !error )
    {
      ...
      if ( IS_HINTED( load_flags ) )
      {
        if ( loader.exec->GS.scan_control )
        {
          ...
          default: /* no drop-out controlClients */
