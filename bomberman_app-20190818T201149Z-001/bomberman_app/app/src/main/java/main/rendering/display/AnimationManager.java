...
public class AnimationManager {
    ...
    public SparseArray<SparseArray<int[]>> mAnimationSequences;
    ...
    public static final int AG000 = 0;
    public static final int AG001 = 1;
    public static final int AG002 = 2;
    public static final int AG003 = 3;
    public static final int AG004 = 4;
    ...
    private final int DRAWABLES[][] = {
            { AG000, ANIMATION_BACKGROUND, R.drawable.sprt_background, 4 },
            { AG001, ANIMATION_BACKGROUND, R.drawable.sprt_background_field, 4 },

            { AG000, ANIMATION_LOADING, R.drawable.sprt_loading, 7 },

            { AG000, ANIMATION_TOUCH_MARKER, R.drawable.touch_square, 10 },
            { AG001, ANIMATION_TOUCH_MARKER, R.drawable.touch_circle, 10 },

            { AG000, ANIMATION_BUTTON, R.drawable.buttonclient, 1 },
            { AG000, ANIMATION_BUTTON_PRESSED, R.drawable.buttonclient_pressed, 1 },

            { AG001, ANIMATION_BUTTON, R.drawable.buttonserver, 1 },
            { AG001, ANIMATION_BUTTON_PRESSED, R.drawable.buttonserver_pressed, 1 },

            { AG002, ANIMATION_BUTTON, R.drawable.buttonbluetooth, 1 },
            { AG002, ANIMATION_BUTTON_PRESSED, R.drawable.buttonbluetooth_pressed, 1 },

            { AG003, ANIMATION_BUTTON, R.drawable.buttonwlan, 1 },
            { AG003, ANIMATION_BUTTON_PRESSED, R.drawable.buttonwlan_pressed, 1 },

            { AG004, ANIMATION_BUTTON, R.drawable.buttonoffline, 1 },
            { AG004, ANIMATION_BUTTON_PRESSED, R.drawable.buttonoffline_pressed, 1 },

            { AG005, ANIMATION_BUTTON, R.drawable.buttonback, 1 },
            { AG005, ANIMATION_BUTTON_PRESSED, R.drawable.buttonback_pressed, 1 },

            { AG006, ANIMATION_BUTTON, R.drawable.button_box, 1 },
            { AG006, ANIMATION_BUTTON_PRESSED, R.drawable.button_box_pressed, 1 },

            { AG000, ANIMATION_PLAYER_WALK_LEFT, R.drawable.robot_walk_left, 12 },
            { AG001, ANIMATION_PLAYER_WALK_LEFT, R.drawable.robot_walk_left2, 12 },

            { AG000, ANIMATION_PLAYER_WALK_RIGHT, R.drawable.robot_walk_right, 12 },
            { AG001, ANIMATION_PLAYER_WALK_RIGHT, R.drawable.robot_walk_right2, 12 },

            { AG000, ANIMATION_PLAYER_WALK_UP, R.drawable.robot_walk_up, 11 },
            { AG001, ANIMATION_PLAYER_WALK_UP, R.drawable.robot_walk_up2, 11 },

            { AG000, ANIMATION_PLAYER_WALK_DOWN, R.drawable.robot_walk_down, 11 },
            { AG001, ANIMATION_PLAYER_WALK_DOWN, R.drawable.robot_walk_down2, 11 },

            { AG000, ANIMATION_PLAYER_STAND, R.drawable.robot_stand, 1 },
            { AG001, ANIMATION_PLAYER_STAND, R.drawable.robot_stand2, 1 },

            { AG000, ANIMATION_PLAYER_DYING, R.drawable.robot_dying, 14 },
            { AG001, ANIMATION_PLAYER_DYING, R.drawable.robot_dying2, 14 },

            { AG000, ANIMATION_PLAYER_BOMB, R.drawable.sprt_bomb, 15 },
            { AG001, ANIMATION_PLAYER_BOMB, R.drawable.sprt_bomb_2, 15 },

            { AG000, ANIMATION_PLAYER_EXPLOSION_CENTER, R.drawable.robot_explosion_center, 3 },
            { AG000, ANIMATION_PLAYER_EXPLOSION_LEFTRIGHT, R.drawable.robot_explosion_horizontal, 3 },
            { AG000, ANIMATION_PLAYER_EXPLOSION_UPDOWN, R.drawable.robot_explosion_vertical, 3 },

            { AG000, ANIMATION_OBJECT_CRATE, R.drawable.object_crate, 1 },
            { AG000, ANIMATION_OBJECT_BLOCK, R.drawable.object_block, 1 },
            { AG000, ANIMATION_NUMBERS, R.drawable.numbers, 10 },
    ...
    public void loadAnimations(Loader loader) {
        ...
        for (int drawnum = 0, texIndex = 0; drawnum < DRAWABLES.length; drawnum++) {
            final int id = DRAWABLES[drawnum][0];
            final int type = DRAWABLES[drawnum][1];
            final int resource = DRAWABLES[drawnum][2];
            final int numOfFrames = DRAWABLES[drawnum][3];
            ...
            switch (type) {
                ...
                case ANIMATION_NUMBERS:
                    for (int idx = 0; idx < numOfFrames; ++idx) {
                        ...
                        animparams[0] = 100;
                        animparams[1] = ANIMATION_PAR_INFINITE;
                        addAnimationSequence(id + idx, type, sequence, animparams);
                    }
                    break;
            }
    ...
    private void addAnimationSequence(int id, int type, int[] animsequence, int[] animparams) {
        SparseArray<int[]> v = mAnimationSequences.get(type);
        if (null == v) {
            v = new SparseArray<>();
            mAnimationSequences.put(type, v);
        }
        v.put(id, animsequence);
    ...
    public void updateAnimatedObject(RenderElement ro, int state) {
        ...
        if (state != ro.getmAnimationState()) {
            ...
            switch (ro.mOptimizationObjectType) {
                case SOBJ_BUTTON_SQUARED:
                case SOBJ_BUTTON:
                    switch (state) {
                        case STATE_UNPRESSED:
                            ao.setAnimationParameters(
                                mAnimationSequences.get(ANIMATION_BUTTON).get(ro.mSubType),
                                mAnimationParameters.get(ANIMATION_BUTTON));
                            break;
                        case STATE_PRESSED:
                            ao.setAnimationParameters(
                                    mAnimationSequences.get(ANIMATION_BUTTON_PRESSED).get(ro.mSubType),
                                    mAnimationParameters.get(ANIMATION_BUTTON_PRESSED));
                            break;
                    }
                case SOBJ_BACKGROUND_LOADING:
                    // ao.setAnimation(mAnimationSequences.get(ANIMATION_LOADING).get(so.mObjectSubtype),
                    // mAnimationParameters.get(ANIMATION_BUTTON));
                    break;
                case SOBJ_TIMER:
                    int[] time = ro.mAdditionalParams;
                    SparseArray<int[]> v = mAnimationSequences.get(ANIMATION_NUMBERS);
                    ro.getAnimation(0).setAnimationParameters(v.get(time[0]),mAnimationParameters.get(ANIMATION_NUMBERS));
                    ro.getAnimation(1).setAnimationParameters(v.get(time[1]),mAnimationParameters.get(ANIMATION_NUMBERS));
                    ro.getAnimation(2).setAnimationParameters(v.get(time[2]),mAnimationParameters.get(ANIMATION_NUMBERS));
                    ro.getAnimation(3).setAnimationParameters(v.get(time[3]),mAnimationParameters.get(ANIMATION_NUMBERS));
                    break;
                case OBJ_PLAYR:
                    switch (state) {
                        case STATE_ALIVE:
                            ...
                            break;
                        case STATE_DEAD:
                            ao.setAnimationParameters(mAnimationSequences.get(ANIMATION_PLAYER_DYING).get(ro.mSubType), mAnimationParameters.get(ANIMATION_PLAYER_DYING));
                            // SoundManager.playSound(SOUND_DEATH); // TODO- Could be duplicates because of
                            // network, need to change
                            break;
                        case STATE_MOVEDOWN:
                            ao.setAnimationParameters(
                                    mAnimationSequences.get(ANIMATION_PLAYER_WALK_DOWN).get(ro.mSubType),
                                    mAnimationParameters.get(ANIMATION_PLAYER_WALK_DOWN));
                            break;
                        case STATE_MOVEUP:
                            ao.setAnimationParameters(
                                    mAnimationSequences.get(ANIMATION_PLAYER_WALK_UP).get(ro.mSubType),
                                    mAnimationParameters.get(ANIMATION_PLAYER_WALK_UP));
                            break;
                        case STATE_MOVELEFT:
                            ao.setAnimationParameters(
                                    mAnimationSequences.get(ANIMATION_PLAYER_WALK_LEFT).get(ro.mSubType),
                                    mAnimationParameters.get(ANIMATION_PLAYER_WALK_LEFT));
                            break;
                        case STATE_MOVERIGHT:
                            ao.setAnimationParameters(
                                    mAnimationSequences.get(ANIMATION_PLAYER_WALK_RIGHT).get(ro.mSubType),
                ...
                case OBJ_BOMB:
                    switch (state) {
                        case STATE_EXPLODED:
                            ...
                            ao.setAnimationParameters(
                                    mAnimationSequences.get(ANIMATION_PLAYER_EXPLOSION_CENTER).get(ro.mSubType),
                            ...
                            for (int i = 1; i <= strength; i++) {
                                ...
                                if (i <= left) {
                                    ...
                                    ao.init(xy);
                                    ao.setAnimationParameters(
                                            mAnimationSequences.get(ANIMATION_PLAYER_EXPLOSION_LEFTRIGHT).get(ro.mSubType),
                                ...
                                if (i <= up) {
                                    ...
                                    ao.init(xy);
                                    ao.setAnimationParameters(
                                            mAnimationSequences.get(ANIMATION_PLAYER_EXPLOSION_UPDOWN).get(ro.mSubType),
    ...
    public void createAnimatedObject(RenderElement ro, int laynum) {
        ...
        switch (ro.mOptimizationObjectType) {
            case SOBJ_BACKGROUND:
                ...
                ao.setAnimationParameters(mAnimationSequences.get(ANIMATION_BACKGROUND).get(ro.mSubType),
                        mAnimationParameters.get(ANIMATION_BACKGROUND));
                ro.addAnimation(ao);
                break;
            case SOBJ_BUTTON:
            case SOBJ_BUTTON_SQUARED:
            ...
            case SOBJ_BACKGROUND_LOADING:
                ...
                ao.setAnimationParameters(mAnimationSequences.get(ANIMATION_LOADING).get(ro.mSubType),
                        mAnimationParameters.get(ANIMATION_LOADING));
                ro.addAnimation(ao);
                break;
            case SOBJ_TOUCH:
                ao = getFreeAnimationFromPool();
                ao.init(gameTouchOffsetXY);
                ao.setAnimationParameters(mAnimationSequences.get(ANIMATION_TOUCH_MARKER).get(ro.mSubType),
                        mAnimationParameters.get(ANIMATION_TOUCH_MARKER));
                ro.addAnimation(ao);
                break;
            case SOBJ_TIMER:
                for (int idx = 0; idx < gameTimer2ndOffsets.length; ++idx) {
                    ...
                    ao.setAnimationParameters(mAnimationSequences.get(ANIMATION_NUMBERS).get(ro.mSubType), mAnimationParameters.get(ANIMATION_NUMBERS));
                    ro.addAnimation(ao);
                }
                break;
            ...
            case OBJ_BLOCK:
                ...
                ao.setAnimationParameters(mAnimationSequences.get(ANIMATION_OBJECT_BLOCK).get(ro.mSubType), mAnimationParameters.get(ANIMATION_OBJECT_BLOCK));
                ro.addAnimation(ao);
                break;
            case OBJ_CRATE:
                ao = getFreeAnimationFromPool();
                ao.init(gameObjectOffsetXY);
                ao.setAnimationParameters(mAnimationSequences.get(ANIMATION_OBJECT_CRATE).get(ro.mSubType), mAnimationParameters.get(ANIMATION_OBJECT_CRATE));
                ro.addAnimation(ao);
                break;
            case OBJ_BOMB:
                ao = getFreeAnimationFromPool();
                ao.init(gameBombOffsetXY);
                ao.setAnimationParameters(mAnimationSequences.get(ANIMATION_PLAYER_BOMB).get(ro.mSubType), mAnimationParameters.get(ANIMATION_PLAYER_BOMB));
                ro.addAnimation(ao);
                break;
            case OBJ_EXPLN:
