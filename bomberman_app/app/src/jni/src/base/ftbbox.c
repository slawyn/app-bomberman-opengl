...
#define CHECK_Y( p, bbox )  \
  ...
  /*                                                                       */
  /*    y2  :: The coordinate of the controlClients point.                        */
  /*                                                                       */
  ...
  /*                                                                       */
  /* <Input>                                                               */
  /*    controlClients :: A pointer to a controlClients point.                           */
  /*                                                                       */
  /*    to      :: A pointer to the destination vector.                    */
  /*                                                                       */
  /* <InOut>                                                               */
  ...
  /*                                                                       */
  /*    p2  :: The coordinate of the first controlClients point.                  */
  /*                                                                       */
  /*    p3  :: The coordinate of the second controlClients point.                 */
  /*                                                                       */
 ...
 /* FT_Pos    a = y4 - 3*y3 + 3*y2 - y1; */
  ...
  /*                                                                       */
  /* <Input>                                                               */
  /*    control1 :: A pointer to the first controlClients point.                  */
  /*                                                                       */
  /*    control2 :: A pointer to the second controlClients point.                 */
  /*                                                                       */
  /*    to       :: A pointer to the destination vector.                   */
  /*                                                                       */
  /* <InOut>                                                               */
...
FT_DEFINE_OUTLINE_FUNCS(bbox_interface,
                       ...
                       FT_BBox     *abbox )
  {
    ...
    /* We compute the controlClients box as well as the bounding box of  */
    /* all `on' points in the outline.  Then, if the two mBoxes    */
    ...
    /* test two mBoxes for equality */
    if ( cbox.xMin < bbox.xMin || cbox.xMax > bbox.xMax ||
         cbox.yMin < bbox.yMin || cbox.yMax > bbox.yMax )
    {
      /* the two mBoxes are different, now walk over the outline to */
